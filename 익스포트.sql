...
--------------------------------------------------------
DROP TABLE "CARMU"."CARMU" cascade constraints;
...
SET DEFINE OFF;
Insert into CARMU.CARMU (MEMBER_ID,MEMBER_PW,MEMBER_NAME,MEMBER_NICNAME,MEMBER_EMAIL,MEMBER_PHONE,MEMBER_DATE) values ('zkdhk1','85090909','김현우','ㅋㅋ','zkdhk1@naver.com','01075738416',to_date('23/08/02','RR/MM/DD'));
...
Insert into CARMU.CARMU (MEMBER_ID,MEMBER_PW,MEMBER_NAME,MEMBER_NICNAME,MEMBER_EMAIL,MEMBER_PHONE,MEMBER_DATE) values ('zkdhk123','85090909','강강후','강강','asdsad2naver.com','01075374816',to_date('23/08/08','RR/MM/DD'));
Insert into CARMU.CARMU (MEMBER_ID,MEMBER_PW,MEMBER_NAME,MEMBER_NICNAME,MEMBER_EMAIL,MEMBER_PHONE,MEMBER_DATE) values ('e232323','85090909','김현우','김현우','fdsjkid@naver.com','01075738416',to_date('23/08/08','RR/MM/DD'));
REM INSERTING into CARMU.KORFREEBOARD
SET DEFINE OFF;
Insert into CARMU.KORFREEBOARD (NOTICE_NO,NOTICE_SUBJECT,NOTICE_CONTENT,NOTICE_WRITER,NOTICE_DATE,NOTICE_GOOD,NOTICE_VIEW,NOTICE_COMMENT) values (21,'ãã',' ããã','admin',to_date('23/08/04','RR/MM/DD'),0,0,0);
